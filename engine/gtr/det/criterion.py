...
class GTRCriterion(nn.Module):
    ...
    def __init__(self, \
        ...
        self.mask_point_sample_ratio = getattr(matcher, 'mask_point_sample_ratio', None) or mask_point_sample_ratio
    ...
    def loss_labels_mal(self, outputs, targets, indices, num_boxes, values=None):
        ...
        if os.getenv('GTR_FAST_MAL_LOSS', '0') == '1':
            ...
            if target_classes_o.numel() > 0:
                ...
                arange = torch.arange(target_classes_o.numel(), device=src_logits.device)
                ...
                pos_loss = F.binary_cross_entropy_with_logits(pos_logits, target_score, reduction='none')
    ...
    def loss_boxes(self, outputs, targets, indices, num_boxes, boxes_weight=None):
        ...
        target_boxes_xyxy = box_cxcywh_to_xyxy(target_boxes)
        if os.getenv('GTR_ELEMENTWISE_BOX_IOU', '1') == '1':
            loss_giou = 1 - paired_generalized_box_iou(src_boxes_xyxy, target_boxes_xyxy)
        else:
    ...
    def loss_masks(self, outputs, targets, indices, num_boxes):
        ...
        """
        assert 'pred_masks' in outputs and outputs['pred_masks'] is not None, "pred_masks missing"
        ...
        num_points = max(src_masks.shape[-2],
    ...
    def forward(self, outputs, targets, **kwargs):
        ...
        share_matched_indices = self.share_matched_indices or os.getenv('GTR_SHARE_MATCHED_INDICES', '0') == '1'
